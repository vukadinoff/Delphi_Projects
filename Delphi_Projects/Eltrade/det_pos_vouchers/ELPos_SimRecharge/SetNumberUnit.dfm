object SetNumberForm: TSetNumberForm
  Left = 378
  Top = 147
  Width = 504
  Height = 606
  ...
  object pMain: TPanel
    ...
    object btnVivacom: TdxSpeedButton
      Tag = 3
      Left = 201
      Top = 354
      Width = 100
      ...
      About = 'Design eXperience. '#169' 2002 M. Hoffmann'
      Version = '1.0.2g'
      OnClick = btnVivacomClick
      Caption = #1042#1080#1074#1072#1082#1086#1084
      Colors.BackgroundTo = 12500670
      Colors.BorderLine = cl3DDkShadow
      Colors.ClickedFrom = 12500670
      Colors.ClickedTo = clWhite
    ...
    object lNumberData: TLabel
      Left = 180
      Top = 20
      Width = 205
      Height = 25
      AutoSize = False
      Caption = '359 ___ ___ ___'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -24
      Font.Name = 'MS Sans Serif'
